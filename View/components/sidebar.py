        ...
        if selected_page not in ["Home", "Análise de dados"]:
            ...
            if not bancos_de_dados:
                ...
                if nome_banco_selecionado:
                    ...
                    # salvar nome do banco selecionado no session_state para outras views
                    try:
                        st.session_state['nome_banco_selecionado'] = nome_banco_selecionado
                    except Exception:
                        pass

    # Paletas centralizadas: 'discrete' para categorias, 'continuous' para escalas numéricas
    rocket_palette = {
        'discrete': [
            "#160141", "#260446", "#3A0453", "#66135C", "#792860",
            "#A53950", "#a54848", "#A06444", "#9E7E42", "#AC973C"
        ],
        'continuous': [
            "#160141", "#260446", "#3A0453", "#66135C", "#792860",
            "#A53950", "#a54848", "#A06444", "#9E7E42", "#AC973C"
